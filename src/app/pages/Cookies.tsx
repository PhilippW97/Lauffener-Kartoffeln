      ...
      <section className="bg-eggshell w-full px-5 md:px-16 2xl:px-24 py-16 md:py-24 2xl:py-28">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="font-['Proza_Libre:Regular',sans-serif] text-[#0c0c0b] text-base leading-relaxed mb-4">
          ...
          <div className="flex flex-col gap-6 mb-12">
            ...
            {/* Essential Cookies */}
            <div className="bg-white rounded-lg p-6 border border-[rgba(12,12,11,0.1)]">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h3 className="font-['Nunito_Sans:Bold',sans-serif] font-bold text-xl tracking-tight text-[#0c0c0b] mb-2" style={{ fontVariationSettings: "'YTLC' 500, 'wdth' 100" }}>
                    Essenzielle Cookies
                  </h3>
                  <p className="font-['Proza_Libre:Regular',sans-serif] text-[#0c0c0b] text-sm leading-relaxed mb-2">
                    Diese Cookies sind für die grundlegende Funktionalität der Website erforderlich und können nicht deaktiviert werden.
                  </p>
                  <p className="font-['Proza_Libre:Regular',sans-serif] text-[#0c0c0b]/60 text-xs">
                ...
                <div className="ml-4">
                  ...
                  <p className="font-['Proza_Libre:Regular',sans-serif] text-[#0c0c0b]/60 text-xs mt-1 text-center">
                    Immer aktiv
                  </p>
                </div>
              </div>
                ...
                <div className="ml-4">
                  <button
                    ...
                    className={`flex items-center justify-center w-12 h-6 rounded-full transition-colors ${
                      analyticsEnabled ? 'bg-dusty-olive' : 'bg-[rgba(12,12,11,0.2)]'
                    }`}
                  >
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="ml-4">
                  <button
                    ...
                    className={`flex items-center justify-center w-12 h-6 rounded-full transition-colors ${
                      marketingEnabled ? 'bg-dusty-olive' : 'bg-[rgba(12,12,11,0.2)]'
                    }`}
                  >
                    <div className={`w-5 h-5 bg-white rounded-full transition-transform ${
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <button 
              ...
              className="flex-1 bg-dusty-olive px-6 py-3 rounded-md text-white font-['Proza_Libre:Medium',sans-serif] text-base shadow-[0px_1px_2px_0px_rgba(12,12,11,0.05),inset_0px_32px_24px_0px_rgba(255,255,255,0.05),inset_0px_2px_1px_0px_rgba(255,255,255,0.25),inset_0px_0px_0px_1px_rgba(12,12,11,0.15),inset_0px_-2px_1px_0px_rgba(0,0,0,0.2)] hover:opacity-90 transition-opacity"
            >
              Auswahl speichern
            </button>
            <button 
              onClick={handleAcceptAll}
              className="flex-1 bg-logo-color px-6 py-3 rounded-md text-white font-['Proza_Libre:Medium',sans-serif] text-base shadow-[0px_1px_2px_0px_rgba(12,12,11,0.05)] hover:opacity-90 transition-opacity"
            >
              Alle akzeptieren
            </button>
            <button 
              onClick={handleRejectAll}
              className="flex-1 bg-white border border-[rgba(12,12,11,0.2)] px-6 py-3 rounded-md text-[#0c0c0b] font-['Proza_Libre:Medium',sans-serif] text-base hover:bg-[rgba(12,12,11,0.05)] transition-colors"
            >
              Alle ablehnen
            </button>
          </div>

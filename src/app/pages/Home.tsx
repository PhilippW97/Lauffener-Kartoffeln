...
import imgHeader111 from "@/assets/31199fb2b3321a4aacc4d0bdf86d632c0a45fb97.png";
...
import imgPlaceholderImage from "@/assets/eedbd0171597a937373c772b9e3139a2e3755249.png";
import imgPlaceholderImage9 from "@/assets/12d6e484f2e950e63d17b87ae2934c326d41c181.png";
...
function InstagramSection() {
  return (
    <section className="bg-eggshell w-full px-5 md:px-16 2xl:px-24 py-16 md:py-24 2xl:py-28">
      <div className="max-w-7xl mx-auto">
        <div className="text-center text-[#0c0c0b] max-w-3xl mx-auto mb-12 2xl:mb-20">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 2xl:gap-8">
          <img src={imgPlaceholderImage8} alt="Instagram post 1" className="w-full rounded-lg object-cover aspect-[3/4] md:row-span-2" />
          <img src={imgPlaceholderImage2} alt="Instagram post 2" className="w-full rounded-lg object-cover aspect-video" />
          <img src={imgPlaceholderImage7} alt="Instagram post 3" className="w-full rounded-lg object-cover aspect-video" />
        </div>
      </div>
    </section>
  );

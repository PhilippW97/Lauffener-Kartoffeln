  ...
  return (
    <footer className="bg-eggshell w-full px-5 md:px-16 2xl:px-24 py-8">
      <div className="max-w-7xl mx-auto">
        <div className="w-full h-px bg-dark-charcoal/15 mb-8" />
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 font-proza text-dark-charcoal text-sm">
